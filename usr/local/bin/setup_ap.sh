...
# Use existing hostapd.conf file
if [ ! -f "/etc/hostapd/hostapd.conf" ]; then
    # If it doesn't exist, use default configuration
...
if [ ! -f "/etc/nginx/sites-available/captive-portal" ]; then
    # If it doesn't exist, use default configuration
...
if [ ! -f "/var/www/portal/logo.png" ]; then
...
# Make sure the WiFi portal script exists and is executable
log "Setting up WiFi portal service"
if [ ! -f "/usr/local/bin/wifi_portal.py" ]; then
    # If it doesn't exist, create it with default content
